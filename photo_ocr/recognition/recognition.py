...
class Recognition:
    def __init__(self,
        ...
        :param model_init_function: one of the initialisation functions in the photo_ocr.recognition.model_zoo
        ...
        self.model = model_init_function(image_shape=image_shape, pretrained=True, progress=True)
        self.model.eval()

        # converting prediction scores to predicted characters
        self.postprocess = self.model.decode

    def __call__(self, images: List[Image.Image]) -> List[Tuple[str, float]]:
        """
