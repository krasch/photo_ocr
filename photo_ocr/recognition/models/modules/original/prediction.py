# copied from https://github.com/clovaai/deep-text-recognition-benchmark/blob/master/modules/prediction.py
...
# a bunch of to_device calls have been removed compared to the original file!
